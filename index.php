...
fwrite($logstrem, "IP: $ip || MOMENT OF REQUEST: $moment \n");
?>
</h2>
<p id="p3" style="color: red; font-size: 25px;">O sa imi pierd toti banii la pacanele pentru ca saracia face omul. - D$<button id="b1" style="size: 50px;" type="button" onclick="titleMovmento();">titleMovmento();</button>
...
<a id="a3" style="font-size: 20px; color: rgb(0, 128, 255);" href="http://smekker.go.ro/old-home/hrusca-pusca">HRUSCA $<a id="aip" style="font-size 20px; color: black;" href="log.txt">IP LOG</a>
...
<p width="20" height="10" id="art" style="position: absolute; color: black; background-color: green; top: 380px; left:$<p width="20" height="10" id="art" style="position: absolute; color: black; background-color: green; top: 395px; left:$<p width="20" height="10" id="art" style="position: absolute; color: black; background-color: green; top: 410px; left:$<p width="20" height="10" id="art" style="position: absolute; color: black; background-color: green; top: 425px; left:$<p width="20" height="10" id="art" style="position: absolute; color: black; background-color: green; top: 440px; left:$<p width="20" height="10" id="art" style="position: absolute; color: black; background-color: green; top: 455px; left:$<img id="sus"  src="amgus.jpg" width="370" height="240"></img>
